    ...
    <div className="min-h-screen bg-[#E8E8F0] dark:bg-dark-bg relative">
      ...
      <section className="pt-24 pb-12 px-4 sm:px-6 lg:px-10 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 dark:text-dark-text">User Management</h1>
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center justify-end gap-2">
                      <select
                        ...
                        className="px-2.5 py-1.5 bg-[#F4F2FA] dark:bg-dark-bg-tertiary border border-[#E2E0F0] dark:border-dark-border rounded-lg text-slate-700 dark:text-dark-text text-sm focus:outline-none focus:border-[#9370DB] transition-colors cursor-pointer"
                        title="Change role"
                      >
                        {roles.map((r) => (
