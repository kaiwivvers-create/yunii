  ...
  return (
    <div className="min-h-screen bg-[#E8E8F0] dark:bg-dark-bg relative overflow-hidden">
      ...
      <section className="pt-24 pb-12 px-4 max-w-4xl mx-auto relative z-10">
        ...
        <p className="text-slate-800 dark:text-dark-text-secondary mb-8">{t('settingsSubtitle')}</p>
        ...
        <div className="bg-[#C8C8E0] dark:bg-dark-bg-secondary border border-[#A8A8C8] dark:border-dark-border rounded-lg p-6 space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-dark-text">{t('academicPreferences')}</h2>
            <div>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-dark-text">{t('locationPreferences')}</h2>
            <div>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-dark-text">{t('financialPracticalPreferences')}</h2>
            <div>
          ...
          {/* Language & Other */}
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-dark-text">{t('languageOther')}</h2>
            <div>
          ...
          {/* App Settings */}
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-dark-text">{t('appSettings')}</h2>
            <div>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-dark-text">{t('notifications')}</h2>
          ...
          {/* Account Settings */}
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-dark-text">{t('account')}</h2>
            <div>
          ...
          <div className="space-y-4 pt-4 border-t border-[#A8A8C8] dark:border-dark-border">
            <h2 className="text-xl font-semibold text-[#ff6b6b]">{t('dangerZone')}</h2>
            <p className="text-sm text-slate-600 dark:text-dark-text-secondary">{t('dangerZoneDesc')}</p>
            <button
              onClick={() => {
